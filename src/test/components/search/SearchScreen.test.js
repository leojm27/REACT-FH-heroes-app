...
describe('Pruebas en <SearchScreen />', () => {
    ...
    test('debe de llamar el navigate a la nueva pantalla ', () => {
        ...
        expect(mockNavigate).toHaveBeenCalled(); // espero que haya sido llamado 
        expect(mockNavigate).toHaveBeenCalledWith('?q=batman'); // espero que haya sido llamado con 'q=batman'
